...
//	GrCircleFill(&sContext, 20,20,15);
	...
	GrStringDraw(&sContext,&pucBuf, 16,40,10, 16);
}
...
void Timer0IntHandler()
{
	...
	if(adc_busy==0)
	{
		...
		adc_busy=1;
		GPIOPinWrite(GPIO_PORTG_BASE,GPIO_PIN_1,(~GPIOPinRead(GPIO_PORTG_BASE,GPIO_PIN_1)));
	}
}
