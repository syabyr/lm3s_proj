/*******************************************************************
DB0-DB7:PH0-PH7,16bit液晶数据总线的低8位
DB8-DB15:PJ0-PJ7,16bit液晶数据总线的高8位
CS:PE0,片选,同时选中液晶和背光
RS:PE1,寄存器选择
WR:PE2,读数据
RD:PE3,写数据
...
#ifndef __320x480_9B95_H__
#define __320x480_9B95_H__
...
//创建一个驱动类型
extern const tDisplay g_sLCD_320x480_9B95;
