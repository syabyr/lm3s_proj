...
/*---------------------------- I2Cx CR2 Configuration ------------------------*/
  ...
  tmpreg |= freqrange;
  /* Write to I2Cx CR2 */
  I2Cx->CR2 = tmpreg;   //36MHz

/*---------------------------- I2Cx CCR Configuration时钟控制器 ------------------------*/
  /* Disable the selected I2C peripheral to configure TRISE */
  I2Cx->CR1 &= CR1_PE_Reset;  //CCR寄存器必须在I2C禁止时配置

  /* Reset tmpreg value */
  /* Clear F/S, DUTY and CCR[11:0] bits */
  tmpreg = 0;

  /* Configure speed in standard mode标准模式 */
  if (I2C_InitStruct->I2C_ClockSpeed <= 100000)
  {
    ...
    I2Cx->TRISE = freqrange + 1;  //根据I2C协议，最大上升时间=1000ns
  }
