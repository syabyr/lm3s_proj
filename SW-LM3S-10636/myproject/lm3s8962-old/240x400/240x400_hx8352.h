#ifndef __240X400_HX8352_H__
#define __240X400_HX8352_H__
...
//打开背光
extern void LCD_240x400_HX8352BacklightOn(void);
//关闭背光
extern void LCD_240x400_HX8352BacklightOff(void);
//液晶初始化
extern void LCD_240x400_HX8352Init(void);
//获取驱动器的ID
extern unsigned short LCD_240x400_HX8352ControllerIdGet(void);
//画一个像素
extern void LCD_240x480_HX8352PixelDraw(unsigned long lX,unsigned long lY,
								unsigned long ulValue);

//绘制多个像素
extern void LCD_240x480_HX8352PixelDrawMultiple(void *pvDisplayData,long lX,long lY,long lX0,long lCount,
									long lBPP,
									const unsigned char *pucData,
									const unsigned char *pucPalette);

//绘制一条水平的线段
extern void LCD_240x480_HX8352LineDrawH(void *pvDisplayData,long lX1,long lX2,long lY,unsigned long ulValue);
//画一条垂直的线段
extern void LCD_240x480_HX8352LineDrawV(void *pvDisplayData,long lX,long lY1,long lY2,unsigned long ulValue);

void LCD_240x480_HX8352RectFill(void *pvDisplayData,const tRectangle *pRect,unsigned long ulValue);

extern char LCD_240x480_HX8352Flush(void *pvDisplayData);
...
//创建一个驱动类型
extern const tDisplay g_sLCD_240x480_HX8352;
